...
Class Watchitoo extends Component {
    ...
    private function createWatchitooUser($userId, $subjectId=null) {
        ...
        $wUserData = $this->wObj->saveUser(null, 'test7_universito_'.($subjectId ? $subjectId.'_' : null).$userData['User']['email'], $this->getUserPassword($userId), $userData['User']['first_name'], $userData['User']['last_name']);
