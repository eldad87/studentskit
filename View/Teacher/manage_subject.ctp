                ...
                if(data['response']['title'][0]=='Error') {
                    ...
                    switch(newCreationStage) {
                        ...
                        case 4: //Tests done, open publish
                            nextTabId = '#testsTab';
                        break;
                        case 5: //Publish done, open nothing
...
<div class="cont-span15 cbox-space cbox-space">
    <div class="search-all2 sort-mar" id="subjectContainer">
        ...
        <ul class="booking-nav f-pad-norml um-upcoming f-pad-norml1 tab-menu">
            ...
            <li class="<?php echo $classes['files']; ?>" id="filesTab"><a href="#"  class="load3" rel="<?php echo Router::url(array('controller'=>'Teacher','action'=>'subjectFileSystem', $subjectId)); ?>"><?php echo __('Files'); ?></a></li>
            ...
            <?php
                if($classesKeys!=CREATION_STAGE_PUBLISH) {
                    echo '<li class="'.$classes['publish'].'" id="publishTab"><a href="#"  class="load3" rel="'.Router::url(array('controller'=>'Teacher','action'=>'subjectPublish')).'">'.__('Publish').'</a></li>';
                }
            ?>
        </ul>
    </div>
