...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        lmObj.loadMoreButton('#teacher-lessons-invitations-load-more', 'click', '#teacher-lessons-invitations', url, {}, 'get', <?php echo $limit; ?>);
                ...
                <li id="user_lesson_id_<?php echo $lessonInvitation['UserLesson']['user_lesson_id']; ?>">
                    ...
                    <div class="lesson-box space2 left-student-box2 left-student-newbox2 pull-left">
                        ...
                        <div class="lesson-box-footer radius2">
                            <div class="pull-left star"><?php echo $this->Layout->ratingNew($lessonInvitation['Student']['student_average_rating'], false, 'pull-left pad8'); ?></div>
