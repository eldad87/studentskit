    ...
    <div class="up-coming">
        <ul class="subject-morelesson">
			...
			foreach($upcomingAvailableLessons AS $upcomingAvailableLesson) {
				echo '
                <li> <a href="#" class="pull-left">',$this->Html->image($this->Layout->image($upcomingAvailableLesson['TeacherLesson']['image_source'], 58, 58), array('alt' => 'Topic image')),'</a>
...
<a href="#" class="more radius3 gradient2 space9 pull-left lesson-more"><strong>Load More</strong><i class="iconSmall-more-arrow"></i></a>
