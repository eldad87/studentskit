        ...
        <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="control control1">
                    <?php echo $this->Form->input('email',  array('label' => false, 'class'=>'x-large2', 'id'=>'login-email')); ?>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="login-password"><?php echo __('Password'); ?> :</label>
                <div class="control control1">
                    <?php echo $this->Form->input('password', array('label' => false, 'type' => 'password', 'class'=>'x-large2', 'id'=>'login-password')); ?>
                </div>
            </div>
        </fieldset>
        <br />
    ...
    <div class="modal-body">
        ...
        <fieldset>
            <div class="control-group">
                ...
                <div class="control control1">
                    <?php echo $this->Form->input('first_name',  array('label' => false, 'class'=>'x-large2', 'id'=>'register-first_name')); ?>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="register-last_name"><?php echo __('Last name'); ?> :</label>
                <div class="control control1">
                    <?php echo $this->Form->input('last_name',  array('label' => false, 'class'=>'x-large2', 'id'=>'register-last_name')); ?>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="register-email"><?php echo __('Email'); ?>* :</label>
                <div class="control control1">
                    <?php echo $this->Form->input('email',  array('label' => false, 'class'=>'x-large2', 'id'=>'register-email')); ?>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="register-password"><?php echo __('Password'); ?>* :</label>
                <div class="control control1">
                    <?php echo $this->Form->input('password',  array('label' => false, 'type' => 'password', 'class'=>'x-large2', 'id'=>'register-password')); ?>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="register-password2"><?php echo __('Repeat Password'); ?>* :</label>
                <div class="control control1">
                    <?php echo $this->Form->input('password2',  array('label' => false, 'type' => 'password', 'class'=>'x-large2', 'id'=>'register-password2')); ?>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="register-imageUpload"><?php echo __('Profile image'); ?> :</label>
                <div class="control control1">
                    <?php echo $this->Form->input('imageUpload',  array('label' => false, 'type' => 'file', 'class'=>'x-large2', 'id'=>'register-imageUpload')); ?>
                </div>
            </div>
