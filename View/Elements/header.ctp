        ...
        <div class="navbar-inner">
            ...
            <div class="nav-collapse">
                <ul class="nav">
                    ...
                    <li<?php echo $navButtonSelection['request']    ? ' class="active"' : null; ?>><?php echo $this->Html->link('<span>'.__('Wish List').'<span>', array('controller'=>'Requests', 'action'=>'/', 'plugin'=>false), array('title'=>'Account', 'escape'=>false)); ?></li>
