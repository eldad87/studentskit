                        ...
                        <div class="head-back radius1">
                            ...
                            <div class="dropdown pull-right">
                                ...
                                <ul class="dropdown-menu popupcontent-box" role="menu" aria-labelledby="dLabel">
                                    ...
                                    <li><a href="#" class="msg-teacher" data-entity_type="lesson" data-entity_id="<?php echo $lessonInvitation['UserLesson']['user_lesson_id']; ?>" data-to_user_id="<?php echo $lessonInvitation['UserLesson']['teacher_user_id']; ?>"><?php echo __('Message teacher'); ?></a></li>
                    ...
                    <div class="lesson-box space2 right-student-box2 right-student-newbox2">
                        ...
                        <div class="lesson-box-footer radius2">
                            ...
                            <div class="pull-right">
                                <?php
                                echo $this->Layout->toolTip($this->Layout->buildLessonTooltipHtml($lessonInvitation['UserLesson']), null, 'pull-right space23', 'tooltip_'.$lessonInvitation['UserLesson']['user_lesson_id']);
