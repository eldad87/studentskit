    ...
    <div class="fullwidth pull-left space7">
        <?php echo $this->Form->create('User', array('class'=>'sk-form', 'url'=>array('controller'=>'Student', 'action'=>'profile'),
            ...
            <fieldset>
                ...
                <?php echo $this->Form->input('image_source', $this->Layout->styleForInput(array('div'=>array('class'=>'control-group control2'), 'type' => 'file', 'label'=>array('class'=>'control-label', 'text'=>__('Profile image'))  ))); ?>
